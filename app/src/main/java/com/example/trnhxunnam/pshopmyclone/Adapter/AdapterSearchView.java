...
public class AdapterSearchView extends RecyclerView.Adapter <AdapterSearchView.ViewHolder> implements Filterable {
    ...
    public AdapterSearchView(ItemClickmove itemClickmove,Context context,ArrayList<Product> arrayList){
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdapterSearchView.ViewHolder viewHolder, final int i) {
