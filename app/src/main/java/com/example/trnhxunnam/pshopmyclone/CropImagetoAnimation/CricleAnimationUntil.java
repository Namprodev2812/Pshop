package com.example.trnhxunnam.pshopmyclone.CropImagetoAnimation;
...
public class CricleAnimationUntil {
    ...
    public CricleAnimationUntil() {
    }

    public CricleAnimationUntil attachActivity(Activity activity) {
        mContextReference = new WeakReference<Activity>(activity);
        return this;
    }

    public CricleAnimationUntil setTargetView(View view) {
        mTarget = view;
        setOriginRect(mTarget.getWidth(), mTarget.getHeight());
        return this;
    }

    private CricleAnimationUntil setOriginRect(float x, float y) {
        originX = x;
        originY = y;
        return this;
    }

    private CricleAnimationUntil setDestRect(float x, float y) {
        destX = x;
        destY = y;
        return this;
    }

    public CricleAnimationUntil setDestView(View view) {
        mDest = view;
        setDestRect(mDest.getWidth(), mDest.getWidth());
        return this;
    }

    public CricleAnimationUntil setBorderWidth(int width) {
        mBorderWidth = width;
        return this;
    }

    public CricleAnimationUntil setBorderColor(int color) {
        mBorderColor = color;
        return this;
    }

    public CricleAnimationUntil setCircleDuration(int duration) {
        mCircleDuration = duration;
        return this;
    }

    public CricleAnimationUntil setMoveDuration(int duration) {
...
//        mTarget.setVisibility(View.VISIBLE);
    ...
    public CricleAnimationUntil setAnimationListener(Animator.AnimatorListener listener) {
